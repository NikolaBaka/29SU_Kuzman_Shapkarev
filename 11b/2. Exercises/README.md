...
## Условие:
Във файл в Excel създайте таблица със следните колони:
...
Статус (например: "В процес на доставка", "Доставен").
Фирмата има следните изисквания за етикетите:

Ако теглото на колета е над 20 кг, в колоната "Статус" автоматично да се добавя "Специална пратка".
